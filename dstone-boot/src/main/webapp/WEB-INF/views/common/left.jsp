	...
	<div class="inner">
		<nav id="menu">
			...
			<ul>
				...
				<li><a href="<%=request.getContextPath()%>/views/kafka/test">KAFKA테스트</a></li>
				<li><a href="<%=request.getContextPath()%>/views/rabbitmq/test">RABBITMQ테스트</a></li>
				<li><a href="<%=request.getContextPath()%>/views/saga/test">SAGA테스트</a></li>
