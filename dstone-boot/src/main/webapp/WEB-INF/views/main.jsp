	...
	<head>
		...
		<script type="text/javascript">
			function goLoginCheckAjax(){ 
				$.ajax({ 
					type:"POST", 
					url:"<%=net.dstone.boot.common.config.ConfigSecurity.LOGIN_CHECK_ACTION%>", 
					data:{}, 
					dataType:"json", 
			...
			function goLogoutAjax(){ 
				$.ajax({ 
					type:"POST", 
					url:"<%=net.dstone.boot.common.config.ConfigSecurity.LOGOUT_ACTION%>", 
					data:{}, 
					dataType:"json", 
					success:function(data, status, request){
			...
			function doLogoutSubmit(){ 
				document.SUBMIT_FORM.action="<%=net.dstone.boot.common.config.ConfigSecurity.LOGOUT_ACTION%>";
