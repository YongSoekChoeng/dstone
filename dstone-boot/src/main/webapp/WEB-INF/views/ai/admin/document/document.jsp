...
<body class="ai-body">
	...
	<script>
		DstoneAiDocument.init({
			uploadUrl: "<%=requestUtil.getStrContextPath()%>/ai/admin/document/uploadDocument.do",
			listUrl: "<%=requestUtil.getStrContextPath()%>/ai/admin/document/listDocument.do",
			deleteUrl: "<%=requestUtil.getStrContextPath()%>/ai/admin/document/deleteDocument.do"
		});
	</script>
</body>
</html>
