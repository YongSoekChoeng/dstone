	...
	<head>
		...
		<script type="text/javascript">
			...
			function goLoginAjax(){ 
				$.ajax({ 
					type:"POST", 
					url:"<%=net.dstone.boot.common.config.ConfigSecurity.LOGIN_PROCESS_ACTION%>", 
			...
			function doLoginSubmit(){ 
				document.SUBMIT_FORM.action="<%=net.dstone.boot.common.config.ConfigSecurity.LOGIN_PROCESS_ACTION%>";
			...
			<div id="main">
				...
				<div class="inner">
					...
					<section>
						...
						<table border=1>
							<tr>
								<td>ID</td><td><input type="text" name="<%=net.dstone.boot.common.config.ConfigSecurity.USERNAME_PARAMETER%>" value="USER01" ></td>
							</tr>
							<tr>
								<td>PASSWORD</td><td><input type="password" name="<%=net.dstone.boot.common.config.ConfigSecurity.PASSWORD_PARAMETER%>" value="12345678" ></td>
							</tr>
							<tr>
						...
						<table border=1>
							<tr>
								<td>ID</td><td><input type="text" name="<%=net.dstone.boot.common.config.ConfigSecurity.USERNAME_PARAMETER%>" value="ADMIN01" ></td>
							</tr>
							<tr>
								<td>PASSWORD</td><td><input type="password" name="<%=net.dstone.boot.common.config.ConfigSecurity.PASSWORD_PARAMETER%>" value="12345678" ></td>
							</tr>
