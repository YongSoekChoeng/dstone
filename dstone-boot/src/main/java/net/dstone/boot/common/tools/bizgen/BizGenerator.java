package net.dstone.boot.common.tools.bizgen;
...
public class BizGenerator extends BaseObject {
	...
	public static String COMM_CUD_PACKAGE_NAME = "net.dstone.boot.common.biz.cud";
	 ...
	 * @param fileGenYn (소스를 파일로 생성할지 여부.) 예) net.dstone.boot.common.tools.BizGenerator.genVoForCud("TB_EVT_INFO", "이벤트정보", false);
	 */
	public static void genVoForCud(String TABLE_NAME, String TABLE_HAN_NAME, boolean fileGenYn) {
		(new net.dstone.boot.common.tools.bizgen.BizGenerator()).new VoGen().genVoByTable(TABLE_NAME, TABLE_HAN_NAME, net.dstone.boot.common.tools.bizgen.BizGenerator.COMM_CUD_PACKAGE_NAME + ".vo", "", fileGenYn);
	}
	 ...
	 * @param fileGenYn (소스를 파일로 생성할지 여부.) 예) net.dstone.boot.common.tools.BizGenerator.genVoByTable("TB_EVT_INFO", "이벤트정보", "com.test.common.biz.vo", "TbEvtInfoVo", false);
	 */
	public static void genVoByTable(String TABLE_NAME, String TABLE_HAN_NAME, String strVoPackageName, String strVoName, boolean fileGenYn) {
		(new net.dstone.boot.common.tools.bizgen.BizGenerator()).new VoGen().genVoByTable(TABLE_NAME, TABLE_HAN_NAME, strVoPackageName, strVoName, fileGenYn);
	}

	/**
	 * <개요> SQL로 VO 생성하는 메소드. net.dstone.boot.common.tools.BizGenerator.SQL_LOCATION에 정의된 SQL을 기반으로 VO를 생성한다.
	 * 
	 * @param strVoPackageName (VO패키지명. 필수.)
	 * @param strVoName (VO명. 필수)
	 * @param pageYn (페이징용 카운트 멤버를 생성할지 여부. 페이징이 들어가는 화면에 사용되는 VO라면 true로 세팅.)
	 * @param fileGenYn (소스를 파일로 생성할지 여부.) 예) net.dstone.boot.common.tools.BizGenerator.genVoBySql("com.test.biz.event.vo", "EventListVo", true, false);
	 */
	public static void genVoBySql(String strVoPackageName, String strVoName, boolean pageYn, boolean fileGenYn) {
		(new net.dstone.boot.common.tools.bizgen.BizGenerator()).new VoGen().genVoBySql(strVoPackageName, strVoName, pageYn, fileGenYn);
	}
	 ...
	 * @param fileGenYn (소스를 파일로 생성할지 여부.) 예) net.dstone.boot.common.tools.BizGenerator.genSqlForCud("TB_EVT_INFO", "이벤트정보", "event", true, false);
	 */
	public static void genSqlForCud(String TABLE_NAME, String TABLE_HAN_NAME, String strModuleName, boolean cudOnlyYn, boolean fileGenYn) {
		(new net.dstone.boot.common.tools.bizgen.BizGenerator()).new SqlGen().genSqlByTable(TABLE_NAME, TABLE_HAN_NAME, COMM_CUD_PACKAGE_NAME, COMM_CUD_DAO_NAME, strModuleName, cudOnlyYn, fileGenYn);
	}
	 ...
	 * @param strModuleName (모듈명. 필수.)
	 * @param cudOnlyYn (CUD용인지여부. false일 경우 조회용 쿼리를 생성하지 않음.)
	 * @param fileGenYn (소스를 파일로 생성할지 여부.) 예) net.dstone.boot.common.tools.BizGenerator.genSqlByTable("TB_EVT_INFO", "이벤트정보", "com.test.biz.event", "EventDao", "event", false, false);
	 */
	public static void genSqlByTable(String TABLE_NAME, String TABLE_HAN_NAME, String strDaoPackageName, String strDaoName, String strModuleName, boolean cudOnlyYn, boolean fileGenYn) {
		(new net.dstone.boot.common.tools.bizgen.BizGenerator()).new SqlGen().genSqlByTable(TABLE_NAME, TABLE_HAN_NAME, strDaoPackageName, strDaoName, strModuleName, cudOnlyYn, fileGenYn);
	}
	 ...
	 * @param fileGenYn (SQL 소스를 파일로 생성할지 여부.) 예) net.dstone.boot.common.tools.BizGenerator.genSqlBySql( "com.test.biz.event", "EventDao", "listEvent", "이벤트리스트조회", "com.test.biz.event.vo", "EventListVo", "event", true, false);
	 */
	public static void genSqlBySql(String strDaoPackageName, String strDaoName, String strMethodName, String strMethodComment, String strVoPackageName, String strVoName, String strModuleName, boolean pageYn, boolean fileGenYn) {
		(new net.dstone.boot.common.tools.bizgen.BizGenerator()).new SqlGen().genSqlBySql(strDaoPackageName, strDaoName, strMethodName, strMethodComment, strVoPackageName, strVoName, strModuleName, pageYn, fileGenYn);
	}
	 ...
	 * @param fileGenYn (DAO소스를 파일로 생성할지 여부.) 예) net.dstone.boot.common.tools.BizGenerator.genDaoForCud("TB_EVT_INFO", "이벤트정보", true, false);
	 */
	public static void genDaoForCud(String TABLE_NAME, String TABLE_HAN_NAME, boolean cudOnlyYn, boolean fileGenYn) {
		(new net.dstone.boot.common.tools.bizgen.BizGenerator()).new DaoGen().genDaoByTable(TABLE_NAME, TABLE_HAN_NAME, COMM_CUD_PACKAGE_NAME, COMM_CUD_DAO_NAME, cudOnlyYn, fileGenYn);
	}
	 ...
	 * @param strDaoName (DAO 명. 필수.)
	 * @param cudOnlyYn (CUD용인지여부. false일 경우 조회용 메소드를 생성하지 않음.)
	 * @param fileGenYn (DAO소스를 파일로 생성할지 여부.) 예) net.dstone.boot.common.tools.BizGenerator.genDaoByTable("TB_EVT_INFO", "이벤트정보", "com.test.biz.event", "EventDao", false, false);
	 */
	public static void genDaoByTable(String TABLE_NAME, String TABLE_HAN_NAME, String strDaoPackageName, String strDaoName, boolean cudOnlyYn, boolean fileGenYn) {
		(new net.dstone.boot.common.tools.bizgen.BizGenerator()).new DaoGen().genDaoByTable(TABLE_NAME, TABLE_HAN_NAME, strDaoPackageName, strDaoName, cudOnlyYn, fileGenYn);
	}
	 ...
	 * @param fileGenYn (DAO소스를 파일로 생성할지 여부.) 예) net.dstone.boot.common.tools.BizGenerator.genDaoBySql( "com.test.biz.event", "EventDao", "listEvent", "이벤트리스트조회", "com.test.biz.event.vo", "EventListVo", true, false);
	 */
	public static void genDaoBySql(String strDaoPackageName, String strDaoName, String strMethodName, String strMethodComment, String strVoPackageName, String strVoName, boolean listYn, boolean pageYn, boolean fileGenYn) {
		(new net.dstone.boot.common.tools.bizgen.BizGenerator()).new DaoGen().genDaoBySql(strDaoPackageName, strDaoName, strMethodName, strMethodComment, strVoPackageName, strVoName, listYn, pageYn, fileGenYn);
	}
	 ...
	 * @param fileGenYn (SVC소스를 파일로 생성할지 여부.) 예) net.dstone.boot.common.tools.BizGenerator.genSvcForJsp( "com.test.biz.event", "EventService", "com.test.biz.event", "EventDao", "listEvent", "이벤트리스트조회", "com.test.biz.event.vo", "EventListVo", 0, true, false);
	 */
	public static void genSvc(String strSvcPackageName, String strSvcName, String strDaoPackageName, String strDaoName, String strMethodName, String strMethodComment, String strVoPackageName, String strVoName, int CRUD, String strTableName, boolean pageYn, boolean fileGenYn) {
		(new net.dstone.boot.common.tools.bizgen.BizGenerator()).new SvcGen().genSvc(strSvcPackageName, strSvcName, strDaoPackageName, strDaoName, strMethodName, strMethodComment, strVoPackageName, strVoName, CRUD, strTableName, pageYn, fileGenYn);
	}
	 ...
	 * @param pageYn (페이징 여부. CRUD가 0 일 경우에만 의미있음.)
	 * @param fileGenYn (CTRL소스를 파일로 생성할지 여부.) 예) net.dstone.boot.common.tools.BizGenerator.genCtrlForJsp( "com.test.biz.event", "EventController", "com.test.biz.event", "EventService", "listEvent", "이벤트리스트조회", "com.test.biz.event.vo", "EventListVo", 0, "TB_EVENT", "/jsp/event", "/listEventPlain.do", "listEventPlain", true, false);
	 */
	public static void genCtrlForJsp(String strCtrlPackageName, String strCtrlName, String strSvcPackageName, String strSvcName, String strMethodName, String strMethodComment, String strVoPackageName, String strVoName, int CRUD, String strTableName, String strPrefix, String strUri, String strReturnJsp, boolean pageYn, boolean fileGenYn) {
		(new net.dstone.boot.common.tools.bizgen.BizGenerator()).new CtrlGen().genCtrlForJsp(strCtrlPackageName, strCtrlName, strSvcPackageName, strSvcName, strMethodName, strMethodComment, strVoPackageName, strVoName, CRUD, strTableName, strPrefix, strUri, strReturnJsp, pageYn, fileGenYn);
	}
	 ...
	 * @param strUri (메소드 URI. 메소드의 @RequestMapping(value = "")에 들어갈 값. 필수.)
	 * @param pageYn (페이징 여부. CRUD가 0 일 경우에만 의미있음.)
	 * @param fileGenYn (CTRL소스를 파일로 생성할지 여부.) 예) net.dstone.boot.common.tools.BizGenerator.genCtrlForJson( "com.test.biz.event", "EventController", "com.test.biz.event", "EventService", "listEvent", "이벤트리스트조회", "com.test.biz.event.vo", "EventListVo", 0, "TB_EVENT", "/jsp/event", "/listEventPlain.do", false);
	 */
	public static void genCtrlForJson(String strCtrlPackageName, String strCtrlName, String strSvcPackageName, String strSvcName, String strMethodName, String strMethodComment, String strVoPackageName, String strVoName, int CRUD, String strTableName, String strPrefix, String strUri, boolean pageYn, boolean fileGenYn) {
		(new net.dstone.boot.common.tools.bizgen.BizGenerator()).new CtrlGen().genCtrlForJson(strCtrlPackageName, strCtrlName, strSvcPackageName, strSvcName, strMethodName, strMethodComment, strVoPackageName, strVoName, CRUD, strTableName, strPrefix, strUri, pageYn, fileGenYn);
	}
	 ...
	 * @param pageYn (페이징 여부. CRUD가 0 일 경우에만 의미있음.)
	 * @param fileGenYn (WS소스를 파일로 생성할지 여부.) 예) net.dstone.boot.common.tools.BizGenerator.genWsForRestFul( "com.test.biz.event.ws", "WsEventService", "com.test.biz.event", "EventService", "/Event", "PUT", "listEvent", "이벤트리스트조회", "com.test.biz.event.vo.ws", "EventListWsVo", "com.test.biz.event.vo", "EventListVo", 0, "TB_EVENT", "XML", true, false);
	 */
	public static void genWsForRestFul(String strWSPackageName, String strWSName, String strSvcPackageName, String strSvcName, String strWSPath, String strMethodKind, String strMethodName, String strMethodComment, String strWsVoPackageName, String strWsVoName, String strVoPackageName, String strVoName, int CRUD, String strTableName, String strMediaType, boolean pageYn, boolean fileGenYn) {
		(new net.dstone.boot.common.tools.bizgen.BizGenerator()).new WsGen().genWsForRestFul(strWSPackageName, strWSName, strSvcPackageName, strSvcName, strWSPath, strMethodKind, strMethodName, strMethodComment, strWsVoPackageName, strWsVoName, strVoPackageName, strVoName, CRUD, strTableName, strMediaType, pageYn, fileGenYn);
	}
	...
	public static void genTestSrcForJsp(int CRUD, String strTableName, String strPrefix, String strUri, String strVoPackageName, String strVoName, boolean pageYn) {
		(new net.dstone.boot.common.tools.bizgen.BizGenerator()).new TestGen().genTestSrcForJsp(CRUD, strTableName, strPrefix, strUri, strVoPackageName, strVoName, pageYn);
	}
	...
	public static void genTestSrcForJson(int CRUD, String strTableName, String strPrefix, String strUri, String strVoPackageName, String strVoName, boolean pageYn) {
		(new net.dstone.boot.common.tools.bizgen.BizGenerator()).new TestGen().genTestSrcForJson(CRUD, strTableName, strPrefix, strUri, strVoPackageName, strVoName, pageYn);
	}
	 ...
	 * @param strVoName (VO 명-파라메터. 필수.)
	 * @param CRUD (트랜젝션종류 - 0:다건조회, 1:단건조회, 2:입력, 3:수정, 4:삭제.)
	 * @param strMediaType (미디어타입:XML/JSON). 필수.) 예) (new net.dstone.boot.common.tools.BizGenerator()).new TestGen().genTestSrcForWsJquery("/Event", "PUT", "listEvent", "com.test.biz.event.vo", "EventListWsVo", 0, "XML");
	 */
	public static void genTestSrcForWsJquery(String strWSPath, String strMethodKind, String strMethodName, String strVoPackageName, String strVoName, int CRUD, String strMediaType) {
		(new net.dstone.boot.common.tools.bizgen.BizGenerator()).new TestGen().genTestSrcForWsJquery(strWSPath, strMethodKind, strMethodName, strVoPackageName, strVoName, CRUD, strMediaType);
	}
	 ...
	 * @param strVoName (VO 명-파라메터. 필수.)
	 * @param CRUD (트랜젝션종류 - 0:다건조회, 1:단건조회, 2:입력, 3:수정, 4:삭제.)
	 * @param strMediaType (미디어타입:XML/JSON). 필수.) 예) (new net.dstone.boot.common.tools.BizGenerator()).new TestGen().genTestSrcForWsJava("/Event", "PUT", "listEvent", "com.test.biz.event.vo", "EventListWsVo", 0, "XML");
	 */
	public static void genTestSrcForWsJava(String strWSPath, String strMethodKind, String strMethodName, String strVoPackageName, String strVoName, int CRUD, String strMediaType) {
		(new net.dstone.boot.common.tools.bizgen.BizGenerator()).new TestGen().genTestSrcForWsJava(strWSPath, strMethodKind, strMethodName, strVoPackageName, strVoName, CRUD, strMediaType);
	}
		...
		public static TabInfo getTab(String TABLE_NAME){
			...
			try {
				if(tabs.containsKey(TABLE_NAME)){
					...
					// 1. 컬럼기본정보 조회
					ds = net.dstone.boot.common.tools.bizgen.BizGenerator.Util.getCols(TABLE_NAME);
					if(ds != null){
					...
					// 2. 키값 조회
					ds = net.dstone.boot.common.tools.bizgen.BizGenerator.Util.getKeys(TABLE_NAME);
					if(ds != null){
	...
	protected class VoGen {
		 ...
		 * @param strVoName (VO명. 옵션(없을경우 테이블명으로 자동생성))
		 * @param fileGenYn (소스를 파일로 생성할지 여부.) 예) (new net.dstone.boot.common.tools.BizGenerator()).new VoGen().genVoByTable("TB_EVT_INFO", "이벤트정보", "com.test.biz.event.vo", "EventListVo", true);
		 */
		protected void genVoByTable(String TABLE_NAME, String TABLE_HAN_NAME, String strVoPackageName, String strVoName, boolean fileGenYn) {
			...
			if (TABLE_NAME == null || "".equals(TABLE_NAME)) {
				...
				if (strVoPackageName == null || "".equals(strVoPackageName)) {
					strVoPackageName = net.dstone.boot.common.tools.bizgen.BizGenerator.COMM_CUD_PACKAGE_NAME + ".vo";
				}
				...
				try {
					...
					vo.append("public class " + strVoName + " extends net.dstone.boot.common.biz.BaseVo implements java.io.Serializable { ").append("\n");
					if (cols != null) {
		...
		/**
		 * <개요> SQL로 VO 생성하는 메소드. net.dstone.boot.common.tools.BizGenerator.SQL_LOCATION에 정의된 SQL을 기반으로 VO를 생성한다. SQL로 VO 생성하는 메소드.(파일자동생성)
		 * 
		 * @param strVoPackageName (VO패키지명. 필수.)
		 * @param strVoName (VO명. 필수.)
		 * @param pageYn (페이징용 카운트 멤버를 생성할지 여부. 페이징이 들어가는 화면에 사용되는 VO라면 true로 세팅.)
		 * @param fileGenYn (소스를 파일로 생성할지 여부.) 예) (new net.dstone.boot.common.tools.BizGenerator()).new VoGen().genVoBySql("com.test.biz.event.vo", "EventListVo", true);
		 */
	...
	protected class SqlGen {
		 ...
		 * @param strModuleName (모듈명. 필수.)
		 * @param cudOnlyYn (CUD용인지여부. false일 경우 조회용 쿼리를 생성하지 않음.)
		 * @param fileGenYn (SQL 소스를 파일로 생성할지 여부.) 예) (new net.dstone.boot.common.tools.BizGenerator()).new SqlGen().genSqlByTable("TB_EVT_INFO", "이벤트정보", "com.test.biz.event", "EventDao", "event", false, false);
		 */
		 ...
		 * @param strModuleName (모듈명. 필수.)
		 * @param pageYn (카운트 SQL을 생성할지 여부.)
		 * @param fileGenYn (SQL 소스를 파일로 생성할지 여부.) 예) (new net.dstone.boot.common.tools.BizGenerator()).new sqlGen().genSqlBySql("com.test.biz.event", "EventDao", "listEvent", "이벤트리스트", "com.test.biz.event.vo", "EventListVo", "event", true, false);
		 */
	...
	protected class DaoGen {
		 ...
		 * @param strDaoName (DAO 명. 필수.)
		 * @param cudOnlyYn (CUD용인지여부. false일 경우 조회용 메소드를 생성하지 않음.)
		 * @param fileGenYn (DAO소스를 파일로 생성할지 여부.) 예) (new net.dstone.boot.common.tools.BizGenerator()).new DaoGen().genDaoByTable("TB_EVT_INFO", "이벤트정보", "com.test.biz.event", "EventDao", false, false);
		 */
		protected void genDaoByTable(String TABLE_NAME, String TABLE_HAN_NAME, String strDaoPackageName, String strDaoName, boolean cudOnlyYn, boolean fileGenYn) {
			...
			if ((PACKAGE_NAME + "." + daoName).equals(COMM_CUD_PACKAGE_NAME + "." + COMM_CUD_DAO_NAME + "")) {
				nameSpace = PACKAGE_NAME + "." + daoName;
				daoH.append("public class " + daoName + " extends net.dstone.boot.common.biz.BaseDao { ").append("\n");
			} else {
				nameSpace = PACKAGE_NAME + "." + daoName;
				daoH.append("public class " + daoName + " extends net.dstone.boot.common.biz.BaseDao { ").append("\n");
			}
...
//			}
		 ...
		 * @param listYn (리스트성인지 상세조회성인지 여부.)
		 * @param pageYn (카운트 SQL을 생성할지 여부.)
		 * @param fileGenYn (DAO소스를 파일로 생성할지 여부.) 예) (new net.dstone.boot.common.tools.BizGenerator()).new DaoGen().genDaoBySql( "com.test.biz.event", "EventDao", "listEvent", "이벤트리스트조회", "com.test.biz.event.vo", "EventListVo", false, true, false);
		 */
...
//			}
	...
	protected class SvcGen {
		 ...
		 * @param strTableName (테이블 명-CRUD가 2:입력, 3:수정, 4:삭제 일 경우에만 해당)
		 * @param pageYn (페이징 여부. CRUD가 0 일 경우에만 의미있음.)
		 * @param fileGenYn (SVC소스를 파일로 생성할지 여부.) 예) (new net.dstone.boot.common.tools.BizGenerator()).new WsGen().genSvcForJsp( "com.test.biz.event", "EventService", "com.test.biz.event", "EventDao", "listEvent", "이벤트리스트조회", "com.test.biz.event.vo", "EventListVo", 0, true, false);
		 */
		protected void genSvc(String strSvcPackageName, String strSvcName, String strDaoPackageName, String strDaoName, String strMethodName, String strMethodComment, String strVoPackageName, String strVoName, int CRUD, String strTableName, boolean pageYn, boolean fileGenYn) {
			...
			String svcName = "";
			String svcFileName = "";
			String commonDaoAlias = net.dstone.boot.common.tools.bizgen.BizGenerator.COMM_CUD_DAO_NAME.substring(0, 1).toLowerCase() + net.dstone.boot.common.tools.bizgen.BizGenerator.COMM_CUD_DAO_NAME.substring(1);
			...
			try {
				...
				svcH.append(" ").append("\n");
				svcH.append("import net.dstone.boot.common.biz.BaseService; ").append("\n");
				...
				if (!FileUtil.isFileExist(svcFileName)) {
					...
					autowiredPartCUD.append("    private " + net.dstone.boot.common.tools.bizgen.BizGenerator.COMM_CUD_PACKAGE_NAME + "." + net.dstone.boot.common.tools.bizgen.BizGenerator.COMM_CUD_DAO_NAME + " " + commonDaoAlias + "; ").append("\n");
	...
	protected class CtrlGen {
		 ...
		 * @param strReturnJsp (CTRL 리턴JSP명. ModelAndView.setViewName( strPrefix + "/" + strReturnJsp )로 반환. 필수.)
		 * @param pageYn (페이징 여부. CRUD가 0 일 경우에만 의미있음.)
		 * @param fileGenYn (CTRL소스를 파일로 생성할지 여부.) 예) (new net.dstone.boot.common.tools.BizGenerator()).new CtrlGen().genCtrlForJsp( "com.test.biz.event", "EventController", "com.test.biz.event", "EventService", "listEvent", "이벤트리스트조회", "com.test.biz.event.vo", "EventListVo", 0, "TB_EVENT", "/jsp/event", "/listEventPlain.do", "listEventPlain", true, false);
		 */
		protected void genCtrlForJsp(String strCtrlPackageName, String strCtrlName, String strSvcPackageName, String strSvcName, String strMethodName, String strMethodComment, String strVoPackageName, String strVoName, int CRUD, String strTableName, String strPrefix, String strUri, String strReturnJsp, boolean pageYn, boolean fileGenYn) {
			...
			ctrlH.append("public class " + strCtrlName + " extends net.dstone.boot.common.biz.BaseController { ").append("\n");
			ctrlH.append("    ").append("\n");
		 ...
		 * @param strUri (메소드 URI. 메소드의 @RequestMapping(value = "")에 들어갈 값. 필수.)
		 * @param pageYn (페이징 여부. CRUD가 0 일 경우에만 의미있음.)
		 * @param fileGenYn (CTRL소스를 파일로 생성할지 여부.) 예) (new net.dstone.boot.common.tools.BizGenerator()).new CtrlGen().genCtrlForJson( "com.test.biz.event", "EventController", "com.test.biz.event", "EventService", "listEvent", "이벤트리스트조회", "com.test.biz.event.vo", "EventListVo", 0, "TB_EVENT", "/jsp/event", "/listEventPlain.do",true , false);
		 */
		protected void genCtrlForJson(String strCtrlPackageName, String strCtrlName, String strSvcPackageName, String strSvcName, String strMethodName, String strMethodComment, String strVoPackageName, String strVoName, int CRUD, String strTableName, String strPrefix, String strUri, boolean pageYn, boolean fileGenYn) {
			...
			if (CRUD == 0) {
				...
				ctrlConts.append("   		boolean result 			= " + svcAlias + "." + strMethodName + "(paramVo);").append("\n");
				ctrlConts.append("   		// 3. 결과처리").append("\n");
				ctrlConts.append("   		mav.addObject(\"RETURN_CD\", net.dstone.boot.common.biz.BaseController.RETURN_SUCCESS );").append("\n");
	...
	protected class WsGen {
		 ...
		 * @param strMediaType (미디어타입:XML/JSON). 필수.)
		 * @param pageYn (페이징 여부. CRUD가 0 일 경우에만 의미있음.)
		 * @param fileGenYn (WS소스를 파일로 생성할지 여부.) 예) (new net.dstone.boot.common.tools.BizGenerator()).new WsGen().genWsForRestFul( "com.test.biz.event.ws", "WsEventService", "com.test.biz.event", "EventService", "/Event", "PUT", "listEvent", "이벤트리스트조회", "com.test.biz.event.vo", "EventListVo", "com.test.biz.event.ws", "EventListWsVo", 0, "TB_EVENT", "XML", true, false);
		 */
	...
	protected class TestGen {
		 ...
		 * @param strWsVoName (웹서비스VO 명-파라메터. 필수.)
		 * @param CRUD (트랜젝션종류 - 0:다건조회, 1:단건조회, 2:입력, 3:수정, 4:삭제.)
		 * @param strMediaType (미디어타입:XML/JSON). 필수.) 예) (new net.dstone.boot.common.tools.BizGenerator()).new WsGen().genWsTestSrcForJquery("/Event", "PUT", "listEvent", "com.test.biz.event.vo", "EventListWsVo", 0, "XML");
		 */
		private void genTestSrcForWsJquery(String strWSPath, String strMethodKind, String strMethodName, String strWsVoPackageName, String strWsVoName, int CRUD, String strMediaType) {
			...
			if ("XML".equals(strMediaType)) {
				...
				try {
					Object obj = net.dstone.boot.common.tools.datagen.DataGenerator.genRandomData(strWsVoPackageName + "." + strWsVoName, 1);
		 ...
		 * @param strWsVoName (웹서비스VO 명-파라메터. 필수.)
		 * @param CRUD (트랜젝션종류 - 0:다건조회, 1:단건조회, 2:입력, 3:수정, 4:삭제.)
		 * @param strMediaType (미디어타입:XML/JSON). 필수.) 예) (new net.dstone.boot.common.tools.BizGenerator()).new WsGen().genWsTestSrcForJava("/Event", "PUT", "listEvent", "com.test.biz.event.vo", "EventListWsVo", 0, "XML");
		 */
	...
	public static class Util {
		/**
		 * Ajax 파일업로드 시 사용하는 JS소스(ajaxfileupload.js) 생성하는 메소드. 예) net.dstone.boot.common.tools.BizGenerator.Util.genAjaxFileUploadJs();
		 */
