 ...
 *
 * model은 provider=ollama일 때만 의미가 있다 - dstone-ai-engine의 dstone.ai.gateway.ollama-override.model
 ...
 */
public record ChatMessageRequest(String message, Boolean ragEnabled, Boolean toolsEnabled, String provider, String model) {
}
