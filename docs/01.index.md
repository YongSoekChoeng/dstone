...
| [06.dstone-boot.md](06.dstone-boot.md) | 🌐 웹 애플리케이션 프레임워크(WAR) — Spring Security, OAuth2 소셜 로그인, Java 소스 코드 정적 분석기, `dstone-ai-engine` 연동 채팅/RAG 문서업로드 화면 |
...
| [09.dstone-ai-engine.md](09.dstone-ai-engine.md) | 🤖 Spring AI 기반 provider-agnostic AI/MLOps 엔진(JAR) — Chat/Gateway/Session/Prompt(Phase 0~1), RAG(Phase 2), Agent·Tool/Function Calling(Phase 3), **Governance(API Key 인증·Rate Limit·PII Guardrail) & Observability(사용량 로깅)(Phase 4, 진행 중)** |
