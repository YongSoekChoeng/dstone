...
| 호스트에서 접속(Pod별) | `kubectl port-forward -n dstone pod/1번POD아이피 7091:7081`<br>`kubectl port-forward -n dstone pod/2번POD아이피 7092:7081`| Pod별로 접속해 확인할 때 씀. |
