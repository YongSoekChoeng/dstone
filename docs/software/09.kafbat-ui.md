...
## 1. 개요
[Kafka](08.kafka.md) 클러스터를 웹에서 조회/관리하기 위한 관리 콘솔(Kafbat UI, 구 kafka-ui 커뮤니티 포크). Spring Boot 기반 실행 가능 jar로 배포된다.
...
## 7. dstone 프로젝트에서의 역할
[Kafka](08.kafka.md) 로컬 브로커 운영/확인용 부가 도구. dstone 애플리케이션 자체와 직접적인 런타임 의존관계는 없다.
