...
- Jenkins가 같은 호스트에서 이 저장소를 로컬 경로(`file:///app/dstone`)로 직접 체크아웃하는 방식도 쓰인다 — [12.jenkins.md](12.jenkins.md), [../04.cloud-architecture.md](../04.cloud-architecture.md#52-git-저장소-연결-방법-scm-설정값) 참고.
