 ...
 * 찾아서 등록해준다. 샘플은 net.dstone.ai.tools.sample.DateTimeTools와
 * net.dstone.ai.tools.rag.RetrievalTools를 참고하면 된다. @Component를 메타애노테이션으로 이미
 * 포함하고 있어서, 클래스에 @Component를 따로 더 붙일 필요는 없다.
 *
 ...
 * (tools.sample, tools.rag 등)에서 함께 쓰는 애노테이션이기 때문이다.
 */
