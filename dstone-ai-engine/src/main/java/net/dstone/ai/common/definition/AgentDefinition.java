 ...
 */
public record AgentDefinition(String name, String promptName, String description, String model, boolean toolsEnabled, boolean ragEnabled, List<String> allowedCallers) {}
