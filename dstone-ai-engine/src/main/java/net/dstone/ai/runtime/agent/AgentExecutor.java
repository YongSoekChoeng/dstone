...
public class AgentExecutor extends BaseObject {
	...
	public String call(String sessionId, String caller, AgentDefinition agent, Map<String, Object> variables,
			String userMessage) {
		return this.buildSpec(sessionId, caller, agent, variables).user(userMessage).call().content();
	}
	...
	public Flux<String> stream(String sessionId, String caller, AgentDefinition agent, Map<String, Object> variables,
			String userMessage) {
		return this.buildSpec(sessionId, caller, agent, variables).user(userMessage).stream().content();
	}
