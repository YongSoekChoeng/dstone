 ...
 * (@ConfigurationProperties 대신 다른 dstone-ai-engine *Properties 클래스들과 같은 방식이다).
 * 템플릿명별 활성 버전을 dstone.ai.prompt.versions.{name}에 따로 지정하지 않으면
 * dstone.ai.prompt.default-version을 쓴다.
 */
@Component
